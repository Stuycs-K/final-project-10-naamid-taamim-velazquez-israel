...
### June 7, 2024
So turns out the way we were doing GIFs was not lossless... oops
Fear not, I have figured out how to do it anyways
What we can do is

ffmpeg -i gif -codec copy gif
ffmpeg -i gif -compression_level 0 images.png
